package com.lizx.microservice.gatewayservice.filter.accesslog;
...
public class AccessLogGlobalFilter implements GlobalFilter, Ordered {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        normalMsg.append(";params=").append(requestBody.get());
        normalMsg.append(";address=").append(address.getHostName()).append(address.getPort());
